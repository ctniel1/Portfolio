    ...
    <main className="min-h-screen p-6">
      ...
      <div className="mb-8">
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5">
          <li>
            Lead Frontend developer for shifting Domo’s pricing model, generating $200k+ expected
            annual income.
          </li>
          <li>
            Helped rebuild an in-house app store from scratch, participating in tech stack decisions
            and implementing polished UI.
          </li>
          <li>
            Created customer-facing features with React, TypeScript, Next.js, and Kotlin-based
            backend services.
          </li>
          <li>
      ...
      <div className="mb-8">
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5">
          <li>
            Translated Figma designs into functional React components with accessibility and
            performance in mind.
          </li>
          <li>Rebuilt legacy Flash apps into modern React web applications.</li>
          <li>
            Implemented feedback capture systems using Google Sheets APIs without 3rd-party
            libraries.
          </li>
      ...
      <div className="mb-8">
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5">
          <li>
            Built internal portal using React, Node.js, and MySQL to track company-wide workflow and
            orders.
          </li>
      ...
      <div className="mb-8">
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5">
          ...
          <li>
            Collaborated with athletic department teams to build fast, optimized microsites for
            nutrition, sports camps, and boosters.
          </li>
